...
{
    partial class ReadWriteWordDocumentForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label1 = new Label();
            InputTaskCountTextBox = new TextBox();
            label2 = new Label();
            ...
            // 
            // InputTaskCountTextBox
            // 
            InputTaskCountTextBox.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            InputTaskCountTextBox.Location = new Point(440, 38);
            InputTaskCountTextBox.Name = "InputTaskCountTextBox";
            InputTaskCountTextBox.Size = new Size(348, 27);
            InputTaskCountTextBox.TabIndex = 2;
            // 
            // label2
            // 
            ...
            Controls.Add(label2);
            Controls.Add(InputTaskCountTextBox);
            Controls.Add(label1);
            Controls.Add(InputTextBox);
            Name = "ReadWriteWordDocumentForm";
            Text = "Form1";
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private TextBox InputTaskCountTextBox;
